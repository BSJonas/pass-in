...
import rocketseat.com.passin.domain.attendee.exceptions.AttendeeAlredyExistException;
...
public class AttendeeService {
	...
	public void verifyAttendeeSubscription(String eventId, String email){
		...
		if(isAttendeeRegistered.isPresent()) throw new AttendeeAlredyExistException("Attendee is already resgistered");
